        ...
        <div>
            ...
            </div>
            {
                !showCart ? (
                                ...
                                <div className="product-list">
                                    {
                                        category.plants.map((plant, plantIndex) => (
                                            <div className="product-card" key={plantIndex}>
                                                ...
                                                <button disabled={plant.name in addedToCart} className={plant.name in addedToCart ? "product-button-added" : "product-button"} onClick={() => handleAddToCart(plant)}>
                                                    {
                    ...
                    <CartItem onRemove={handleRemove} onContinueShopping={handleContinueShopping} />
                )
            }
        </div>
    );
